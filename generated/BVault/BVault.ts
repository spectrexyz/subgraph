...
export class BVault__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class BVault__getPoolTokenInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class BVault__queryBatchSwapInputSwapsStruct extends ethereum.Tuple {
  get poolId(): Bytes {
...
export class BVault__queryBatchSwapInputFundsStruct extends ethereum.Tuple {
  get sender(): Address {
...
export class BVault extends ethereum.SmartContract {
  static bind(address: Address): BVault {
    return new BVault("BVault", address);
  }
  ...
  getPausedState(): BVault__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new BVault__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<BVault__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new BVault__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getPool(poolId: Bytes): BVault__getPoolResult {
    let result = super.call("getPool", "getPool(bytes32):(address,uint8)", [
      ethereum.Value.fromFixedBytes(poolId)
    ]);

    return new BVault__getPoolResult(result[0].toAddress(), result[1].toI32());
  }

  try_getPool(poolId: Bytes): ethereum.CallResult<BVault__getPoolResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BVault__getPoolResult(value[0].toAddress(), value[1].toI32())
    );
  }
  ...
  getPoolTokenInfo(
    poolId: Bytes,
    token: Address
  ): BVault__getPoolTokenInfoResult {
    let result = super.call(
      "getPoolTokenInfo",
    ...
    return new BVault__getPoolTokenInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress()
  ...
  try_getPoolTokenInfo(
    poolId: Bytes,
    token: Address
  ): ethereum.CallResult<BVault__getPoolTokenInfoResult> {
    let result = super.tryCall(
      "getPoolTokenInfo",
      "getPoolTokenInfo(bytes32,address):(uint256,uint256,uint256,address)",
      [ethereum.Value.fromFixedBytes(poolId), ethereum.Value.fromAddress(token)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BVault__getPoolTokenInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress()
  ...
  getPoolTokens(poolId: Bytes): BVault__getPoolTokensResult {
    let result = super.call(
      "getPoolTokens",
    ...
    return new BVault__getPoolTokensResult(
  ...
  try_getPoolTokens(
    poolId: Bytes
  ): ethereum.CallResult<BVault__getPoolTokensResult> {
    let result = super.tryCall(
      "getPoolTokens",
      "getPoolTokens(bytes32):(address[],uint256[],uint256)",
      [ethereum.Value.fromFixedBytes(poolId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BVault__getPoolTokensResult(
  ...
  queryBatchSwap(
    kind: i32,
    swaps: Array<BVault__queryBatchSwapInputSwapsStruct>,
    assets: Array<Address>,
    funds: BVault__queryBatchSwapInputFundsStruct
  ): Array<BigInt> {
    let result = super.call(
      "queryBatchSwap",
