...
export class Pool__getMiscDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Pool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class Pool__getSampleResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Pool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class Pool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Pool extends ethereum.SmartContract {
  ...
  getMiscData(): Pool__getMiscDataResult {
    let result = super.call(
      "getMiscData",
      "getMiscData():(int256,int256,uint256,uint256,uint256)",
      []
    );

    return new Pool__getMiscDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getMiscData(): ethereum.CallResult<Pool__getMiscDataResult> {
    let result = super.tryCall(
      "getMiscData",
      "getMiscData():(int256,int256,uint256,uint256,uint256)",
      []
  ...
  getPastAccumulators(
    queries: Array<Pool__getPastAccumulatorsInputQueriesStruct>
  ): Array<BigInt> {
    let result = super.call(
      "getPastAccumulators",
  ...
  getPausedState(): Pool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new Pool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getPausedState(): ethereum.CallResult<Pool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getSample(index: BigInt): Pool__getSampleResult {
    let result = super.call(
      "getSample",
    ...
    return new Pool__getSampleResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getSample(index: BigInt): ethereum.CallResult<Pool__getSampleResult> {
    let result = super.tryCall(
      "getSample",
      "getSample(uint256):(int256,int256,int256,int256,int256,int256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(index)]
  ...
  getTimeWeightedAverage(
    queries: Array<Pool__getTimeWeightedAverageInputQueriesStruct>
  ): Array<BigInt> {
    let result = super.call(
      "getTimeWeightedAverage",
  ...
  onSwap(
    request: Pool__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    return new Pool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<Pool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__queryExitResult(value[0].toBigInt(), value[1].toBigIntArray())
    );
  }
  ...
  queryJoin(
    ...
    return new Pool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray()
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes
  ): ethereum.CallResult<Pool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__queryJoinResult(value[0].toBigInt(), value[1].toBigIntArray())
    );
  }

  sERC20IsToken0(): boolean {
    let result = super.call("sERC20IsToken0", "sERC20IsToken0():(bool)", []);

    return result[0].toBoolean();
  }

  try_sERC20IsToken0(): ethereum.CallResult<boolean> {
    let result = super.tryCall("sERC20IsToken0", "sERC20IsToken0():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
