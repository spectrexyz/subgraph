...
export class sERC721 extends ethereum.SmartContract {
  static bind(address: Address): sERC721 {
    return new sERC721("sERC721", address);
  }
  ...
  mint(to: Address, _tokenURI: string): BigInt {
  ...
  try_mint(to: Address, _tokenURI: string): ethereum.CallResult<BigInt> {
